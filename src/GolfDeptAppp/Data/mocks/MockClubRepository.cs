...
namespace GolfDeptAppp.Data.mocks
{
    public class MockClubRepository : IClubRepository
    {
        ...
        public IEnumerable<Club> Clubs
        {
            get
            {
                return new List<Club>
                {
                    new Club {
                        Name = "Nike Driver",
                        Price = 7.95M, ShortDescription = "Tiger woods club",
                        ...
                        ImageThumbnailUrl = "http://be478d95e8aa404656c1-d983ce57e4c84901daded0f67d5a004f.r11.cf1.rackcdn.com/turnberry-isle-miami/media/cache/TIM-Golf-GolfClub-DiscoverOurOnlineGolfStore-594c277a82b70-720x461.jpg"
                    },
                    new Club {
                        Name = "Rum & Coke",
        ...
        public IEnumerable<Club> PreferredClubs { get; }
